...
class TopoFour(Topo):
	...
	self.addLink(h1, s1, cls=TCLink)
	self.addLink(h2, s1, cls=TCLink)
	self.addLink(h3, s6, cls=TCLink)
	self.addLink(h4, s6, cls=TCLink)
	self.addLink(h5, s7, cls=TCLink)
	self.addLink(h6, s7, cls=TCLink)
	self.addLink(h7, s2, cls=TCLink)
	self.addLink(s1, s2, cls=TCLink)
	...
	self.addLink(s3, s4, cls=TCLink)
	self.addLink(s3, s6, cls=TCLink)
	self.addLink(s3, s7, cls=TCLink)
	self.addLink(s4, s5, cls=TCLink)
	self.addLink(s4, s6, cls=TCLink)
	self.addLink(s4, s7, cls=TCLink)
	self.addLink(s5, s6, cls=TCLink)
	self.addLink(s5, s7, cls=TCLink)
